...
export const paths = {
  ...
  dashboard: {
    ...
    kitchen: {
      ...
      settlements: `${ROOTS.DASHBOARD}/kitchen/settlements`,
    },
    order: {
    ...
    groupedOrder: {
      root: `${ROOTS.DASHBOARD}/grouped-order`,
      details: (id: string) => `${ROOTS.DASHBOARD}/grouped-order/${id}`,
    },
    menu: {
    ...
    employee: {
      ...
      list: `${ROOTS.DASHBOARD}/employees/list`,
      new: `${ROOTS.DASHBOARD}/employees/new`,
    },
    map: `${ROOTS.DASHBOARD}/map`,
    // Legacy template pages (kept for reference)
    general: {
