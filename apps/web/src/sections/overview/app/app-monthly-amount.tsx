...
import { fCurrency, fMillionCurrency } from 'src/utils/format-number';
...
export function AppMonthlyAmount({
  title,
  subheader,
  totalLabel,
  categories,
  ...
  const chartOptions = useChart({
    ...
    stroke: { width: 0 },
    xaxis: { categories },
    yaxis: { labels: { formatter: (value: number) => fMillionCurrency(value) } },
