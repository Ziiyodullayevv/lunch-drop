export const notificationIcons = {
  ...
  company_pending: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 21H22V19H2V21ZM20 8H17V4H7V8H4L12 14L20 8ZM9 6H15V8H9V6ZM4 16H20V14.13L12 8.5L4 14.13V16Z" fill="url(#comp_grad)" />
      <circle cx="19" cy="19" r="4" fill="#FF5630" />
      <path d="M18 17H20V19.5L19 20.5L18 19.5V17Z" fill="white" />
      <circle cx="19" cy="21.5" r="0.6" fill="white" />
      <defs>
        <linearGradient id="comp_grad" x1="2" y1="4" x2="22" y2="21" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFAB00" />
          <stop offset="1" stopColor="#B76E00" />
        </linearGradient>
      </defs>
  ...
  employee_pending: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="8" r="4" fill="url(#emp_grad)" />
      <path d="M4 20C4 16.686 7.582 14 12 14C16.418 14 20 16.686 20 20H4Z" fill="url(#emp_grad)" />
      <circle cx="19" cy="19" r="4" fill="#FF5630" />
      <path d="M18 17H20V19.5L19 20.5L18 19.5V17Z" fill="white" />
      <circle cx="19" cy="21.5" r="0.6" fill="white" />
      <defs>
        <linearGradient id="emp_grad" x1="4" y1="4" x2="20" y2="20" gradientUnits="userSpaceOnUse">
  ...
  kitchen_pending: (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 3C18 3 16 5 16 8C16 9.1 16.4 10.1 17 10.8V21H19V10.8C19.6 10.1 20 9.1 20 8C20 5 18 3 18 3Z" fill="#FFAB00" />
      <path d="M11 3V9H9V3H7V9C7 10.86 8.28 12.43 10 12.87V21H12V12.87C13.72 12.43 15 10.86 15 9V3H13V9H11V3H11Z" fill="url(#kit_grad)" />
      <circle cx="19" cy="19" r="4" fill="#FF5630" />
      <path d="M18 17H20V19.5L19 20.5L18 19.5V17Z" fill="white" />
      <circle cx="19" cy="21.5" r="0.6" fill="white" />
      <defs>
        <linearGradient id="kit_grad" x1="7" y1="3" x2="15" y2="21" gradientUnits="userSpaceOnUse">
          <stop stopColor="#77ED8B" />
          <stop offset="1" stopColor="#22C55E" />
        </linearGradient>
      </defs>
